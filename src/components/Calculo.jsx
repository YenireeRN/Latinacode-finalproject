...
const Calculo = () => {
  ...
  return (
    <>
      <form>
        <label htmlFor="numAcciones">Cantidad de Acciones:</label>
        <input
          type="text"
          id="numAcciones"
          name="numAcciones"
        ...
        <br />
        <label>
          Valor Monetario por Acción:{" "}
          <span className="txt-sal">${valorAccion}</span>
        </label>
        <label>
          Valor Total en el Mercado:{" "}
          <span className="txt-sal">${valorTotal.toLocaleString()}</span>
        </label>
      </form>
    </>
  );
